...
let sarchResults = document.querySelector('#search-results')
...
searchButton.addEventListener('click', function () {
  ...
  if (sentence.innerHTML.includes(textBoxInput.value.trim())) {
       console.log('Found');
   }   else {
  ...
  let sentence1 = sentence.innerHTML.toLowerCase();
  let sentence2 = textBoxInput.value.toLowerCase();
